...
class TenantItem extends Component{
    ...
    render(){
        return(
            <div onClick={this.props.onClick} style={{width:250, height:80,paddingLeft:20, display:'flex', alignItems:'center',boxSizing:'border-box', backgroundColor:this.props.isActive? '#9fa8da':'' }} className="tenant-item" >
